...
def concat_nBMST_output_files(input_dir, output_file, chromosome_name, non_b_dna_type, input_file_extension):
...
if __name__ == "__main__":
  ...
  concat_nBMST_output_files(args.input_dir, args.output_file, args.chromosome_name, args.non_b_dna_type, args.input_file_extension)
